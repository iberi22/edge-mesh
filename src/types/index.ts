...
export interface EdgeMeshEventMap {
  ...
  syncCompletado: CustomEvent<{ readonly docId: string; readonly clock: number }>;
  error: CustomEvent<{ readonly mensaje: string; readonly error?: Error }>;
  estadoCambiado: CustomEvent<{ readonly estadoAnterior: EstadoNodo; readonly estadoNuevo: EstadoNodo }>;
  ...
  saludCambiada: CustomEvent<{ readonly nodoId: NodoId; readonly salud: EstadoSalud }>;
}
