...
import type { YjsAdapter, EdgeMesh } from "../edge-mesh.js";
import { ChatChannel, TIPO_CANAL, type Mensaje } from "../chat/index.js";
...
export interface SalonEventMap {
  participanteUnido: CustomEvent<{ readonly salonId: string; readonly participanteId: string }>;
  participanteSalio: CustomEvent<{ readonly salonId: string; readonly participanteId: string }>;
  mensaje: CustomEvent<{ readonly salonId: string; readonly mensaje: Mensaje }>;
  contenidoSincronizado: CustomEvent<{ readonly salonId: string; readonly docId: string }>;
  estadoCambiado: CustomEvent<{ readonly salonId: string; readonly estado: EstadoSalon }>;
  error: CustomEvent<{ readonly salonId: string; readonly mensaje: string; readonly error?: Error }>;
}
