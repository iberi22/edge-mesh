...
import { GovernanceManager, createGovernanceManager, ESTADO_PROPUESTA } from "../../src/governance/index.js";
import { NodoId, POLITICA_GOBERNANZA } from "../../src/types/index.js";
...
describe("GovernanceManager", () => {
  ...
  it("should create a proposal", () => {
    ...
    const propuesta = governanceManager.crearPropuesta(id, tipo, proponente, datos);
  ...
  it("should update policy", () => {
    ...
    expect(governanceManager.obtenerPolitica().politica).toBe(POLITICA_GOBERNANZA.AUTORITARIA);
