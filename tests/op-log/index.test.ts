...
describe("OpLog Module", () => {
  ...
  describe("sync and applications", () => {
    it("should aplicarOperaciones from remote", async () => {
      const remoteOps = [
        { id: "remote:1", tipo: "t1", datos: {}, timestamp: Date.now(), autor: "remote" as NodoId, secuencia: 1 },
        { id: "remote:2", tipo: "t2", datos: {}, timestamp: Date.now(), autor: "remote" as NodoId, secuencia: 2 },
      ];
